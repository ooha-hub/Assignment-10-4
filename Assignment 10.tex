...
\begin{align}
    \myvec{-1 & -1 \\ -1 & 1 \\ 1 & 0}\vec{x} \succeq \myvec{-9\\0\\0}
\end{align}
...
\begin{enumerate}
    \item Now we have,
    \begin{align}
        \myvec{-1 & -1 \\ -1 & 1}\vec{x} &\succeq \myvec{-9 \\ 0}
        \\
        \implies  \myvec{-1 & -1 \\ -1 & 1}\vec{x} &= \myvec{-9 \\ 0} + \vec{u}
    \end{align}
    resulting in 
    \begin{align}
        \vec{x} &= \myvec{-1 & -1 \\-1 & 1}^{-1}\myvec{-9 \\ 0} + \myvec{-1 & -1 \\-1 & 1}^{-1}\vec{u}
        \\
        \implies \vec{x} &=\myvec{ \frac{9}{2}\\ \frac{9}{2}} +\frac{1}{2}\myvec{-1&-1\\-1&1}\vec{u}
    \end{align}
    \item and we have,
    \begin{align}
        \myvec{-1 & -1 \\ 1 & 0}\vec{x} &\succeq \myvec{-9 \\ 0}
        \\
        \implies  \myvec{-1 & -1 \\ 1 & 0}\vec{x} &= \myvec{-9 \\ 0} + \vec{u}
    \end{align}
    resulting in 
    \begin{align}
        \vec{x} &= \myvec{-1 & -1 \\1 & 0}^{-1}\myvec{-9 \\ 0} + \myvec{-1 & -1 \\1 & 0}^{-1}\vec{u}
        \\
        \implies \vec{x} &= \myvec{0\\9} + \myvec{0&1\\-1&-1}\vec{u}
    \end{align}
\end{enumerate}
